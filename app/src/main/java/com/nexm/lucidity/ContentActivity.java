...
public class ContentActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // getSupportActionBar().setSubtitle("Classification of amines");
        ...
        SectionsPagerAdapter sectionsPagerAdapter = new SectionsPagerAdapter(ContentActivity.this, getSupportFragmentManager(),topic_id ,videoID,videoDuration,getIntent().getStringExtra("TOPIC_NAME"),getIntent().getStringExtra("SUBJECT") ,unitID,caller);
